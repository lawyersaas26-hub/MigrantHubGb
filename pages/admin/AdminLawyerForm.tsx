...
const AdminLawyerForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setSaving(true);
        try {
            await updateLawyer(id, formData);
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-slate-900">Edit Lawyer</h1>
                                <p className="text-sm text-slate-600">Update lawyer details</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                            {admin && (
...
export default AdminLawyerForm;
