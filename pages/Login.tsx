                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                className={`w-full ${isRTL ? 'pr-10 pl-4' : 'pl-10 pr-4'} py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all`}
                                placeholder={t.email}
                                dir="ltr"
                            />
                        </div>
